...
def array(object: Any, dtype: Any = None, copy: bool = True, order: str = 'K', subok: bool = False, ndmin: int = 0, like: Any = None) -> ndarray: ...
...
def array(object: Any, dtype: Any = None, copy: bool = True, order: str = 'K', subok: bool = False, ndmin: int = 0) -> ndarray: ...
def asarray(a: Any, dtype: Any = None, order: str = None) -> ndarray: ...
def zeros(shape: Union[int, Tuple[int, ...]], dtype: Any = None, order: str = 'C') -> ndarray: ...
def ones(shape: Union[int, Tuple[int, ...]], dtype: Any = None, order: str = 'C') -> ndarray: ...
