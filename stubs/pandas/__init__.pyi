...
class Series:
    ...
    def expanding(self, min_periods: int = 1, center: Optional[bool] = None, axis: int = 0, method: str = 'single') -> Any: ...
    def ewm(self, com: Optional[float] = None, span: Optional[float] = None, halflife: Optional[float] = None, alpha: Optional[float] = None, min_periods: int = 0, adjust: bool = True, ignore_na: bool = False, axis: int = 0, times: Optional[Any] = None, method: str = 'single') -> Any: ...
    ...
    def cumprod(self, axis: Optional[int] = None, skipna: bool = True) -> 'Series': ...
...
class DataFrame:
    ...
    def set_index(self, keys: Any, drop: bool = True, append: bool = False, inplace: bool = False, verify_integrity: bool = False) -> Optional['DataFrame']: ...
    def to_csv(self, path_or_buf: Any = None, sep: str = ',', na_rep: str = '', float_format: Optional[str] = None, columns: Optional[Any] = None, header: bool = True, index: bool = True, index_label: Optional[Any] = None, mode: str = 'w', encoding: Optional[str] = None, compression: Any = 'infer', quoting: Optional[int] = None, quotechar: str = '"', line_terminator: Optional[str] = None, chunksize: Optional[int] = None, date_format: Optional[str] = None, doublequote: bool = True, escapechar: Optional[str] = None, decimal: str = '.', errors: str = 'strict', storage_options: Optional[Dict[str, Any]] = None) -> Optional[str]: ...
...
def crosstab(index: Any, columns: Any, values: Any = None, rownames: Any = None, colnames: Any = None, aggfunc: Any = None, margins: bool = False, margins_name: str = 'All', dropna: bool = True, normalize: Any = False) -> 'DataFrame': ...
