...
# -*- coding: utf-8 -*-
"""
Анализатор нереализованных функций в Domain слое.
"""
...
class DomainLayerAnalyzer(SharedLayerAnalyzer):
    """Анализатор для domain слоя."""
    
    def __init__(self, project_root: str = ".") -> None:
        super().__init__(project_root)
        self.domain_dir = self.project_root / "domain"
