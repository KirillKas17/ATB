...
class Data (object):
    def __init__(self, bytedata=None) -> None:
...
class URL (object):
    def __init__(self, base, rel=None) -> None:
        if rel is not None:
...
class Bookmark (object):
    def __init__(self, tocs=None) -> None:
        if tocs is None:
    ...
    @classmethod
    def _get_item(cls, data, hdrsize, offset) -> None:
        offset += hdrsize
    ...
    @classmethod
    def _encode_item(cls, item, offset) -> None:
        if item is True:
