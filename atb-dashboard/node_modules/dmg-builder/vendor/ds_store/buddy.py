...
class Block(object):
    def __init__(self, allocator, offset, size) -> None:
    ...
    def read(self, size_or_format) -> None:
    ...
    def write(self, data_or_format, *args) -> None:
        if len(args):
    ...
    def insert(self, data_or_format, *args) -> None:
        if len(args):
            data = struct.pack(data_or_format, *args)
        else:
            data = data_or_format
...
class Allocator(object):
    ...
    @classmethod
    def open(cls, file_or_name, mode='r+') -> None:
    ...
    def read(self, offset, size_or_format) -> None:
    ...
    def write(self, offset, data_or_format, *args) -> None:
    ...
    def _root_block_size(self) -> None:
    ...
    def _write_root_block_into(self, block) -> None:
        # Offsets
    ...
    def _buddy(self, offset, width) -> None:
        f = self._free[width]
        b = offset ^ (1 << width)
    ...
    def _release(self, offset, width) -> None:
        # Coalesce
        while True:
    ...
    def allocate(self, bytes, block=None) -> None:
