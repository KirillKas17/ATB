...
class WindowSizeOptimizer:
    ...
    def __init__(self, config: Optional[WindowConfig] = None) -> None:
        ...
        self.scalers: List[RobustScaler] = []
        self.feature_names: Optional[List[str]] = None
        # Метрики
        self.metrics: Optional[WindowMetrics] = None
        # Режимы рынка
        self.regime_mapping: Dict[str, int] = {
            "трендовый": 0,
            "боковой": 1,
            "разворотный": 2,
            "манипуляционный": 3,
    ...
    def extract_features(
        self, df: DataFrame, meta: Dict[str, Any]
    ) -> Dict[str, float]:
    ...
    def _optimize_hyperparameters(self, X: DataFrame, y: Series) -> Dict[str, Any]:
    ...
    def _update_metrics(self, X: DataFrame, y: Series) -> None:
        """Обновление метрик"""
        try:
            predictions = []
