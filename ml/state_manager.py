...
class StateManager:
    ...
    async def _save_json(self, path: Path, data: Any):
    ...
    async def set_optimal_window(self, pair: str, value: int):
    ...
    async def add_regime(self, pair: str, regime: str):
    ...
    async def set_confidence(self, pair: str, value: float):
