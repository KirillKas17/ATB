...
def test_get_candles(market_data):
...
def test_get_orderbook(market_data):
...
def test_get_trades(market_data):
...
def test_error_handling(market_data):
...
@pytest.mark.asyncio
async def test_initialization(market_data, bybit_client):
    """Тест инициализации"""
...
@pytest.mark.asyncio
async def test_get_candles(market_data):
    """Тест получения свечей"""
    try:
        # Получение данных
...
@pytest.mark.asyncio
async def test_get_orderbook(market_data):
    """Тест получения стакана"""
    try:
        # Получение данных
...
@pytest.mark.asyncio
async def test_get_trades(market_data):
    """Тест получения сделок"""
    try:
        # Получение данных
...
@pytest.mark.asyncio
async def test_get_historical_data(market_data):
    """Тест получения исторических данных"""
    try:
        # Получение данных
...
@pytest.mark.asyncio
async def test_data_cache(data_cache):
    """Тест кеша данных"""
    # Сохранение данных
