...
class TestBybitClient:
    ...
    async def test_connection(self, bybit_client) -> None:
        ...
        with patch("infrastructure.external_services.bybit_client.aiohttp.ClientSession") as mock_session:
    ...
    async def test_websocket_subscription(self, bybit_client) -> None:
        ...
        with patch("infrastructure.external_services.bybit_client.websockets.connect") as mock_ws:
            mock_ws.return_value.__aenter__.return_value.send = AsyncMock()
            mock_ws.return_value.__aenter__.return_value.recv = AsyncMock(return_value='{"type":"ping"}')
    ...
    async def test_get_orderbook(self, bybit_client) -> None:
        ...
        with patch("infrastructure.external_services.bybit_client.exchange.bybit_client.aiohttp.ClientSession") as mock_session:
            mock_response = {
                "ret_code": 0,
