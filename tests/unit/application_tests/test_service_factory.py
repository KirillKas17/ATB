...
class TestDefaultServiceFactory:
    ...
    @pytest.mark.asyncio
    def test_initialize_all_services(self: "TestDefaultServiceFactory") -> None:
    ...
    @pytest.mark.asyncio
    def test_stop_all_services(self: "TestDefaultServiceFactory") -> None:
...
class TestServiceFactoryIntegration:
    ...
    def setup_method(self) -> Any:
        ...
        self.factory = DefaultServiceFactory(self.config)
    @pytest.mark.asyncio
    def test_full_service_lifecycle(self: "TestServiceFactoryIntegration") -> None:
