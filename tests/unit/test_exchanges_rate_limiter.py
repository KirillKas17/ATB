...
class TestRateLimiter:
    ...
    @pytest.mark.asyncio
    async def test_rate_limiter_edge_cases(self: "TestRateLimiter") -> None:
    ...
    @pytest.mark.asyncio
    async def test_rate_limiter_zero_limit(self: "TestRateLimiter") -> None:
    ...
    @pytest.mark.asyncio
    async def test_rate_limiter_large_window(self: "TestRateLimiter") -> None:
