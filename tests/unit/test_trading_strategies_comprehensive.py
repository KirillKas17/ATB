...
class TestStrategyFactory:
    ...
    def test_create_trend_strategy(self, strategy_factory: StrategyFactory):
        ...
        config = {"strategy_type": "trend", "ema_fast": 12, "ema_slow": 26, "risk_percentage": 0.02}
    ...
    def test_create_mean_reversion_strategy(self, strategy_factory: StrategyFactory):
        ...
        config = {"strategy_type": "mean_reversion", "bb_period": 20, "bb_std": 2.0, "rsi_period": 14}
    ...
    def test_create_invalid_strategy_type(self, strategy_factory: StrategyFactory):
        ...
        config = {"strategy_type": "nonexistent_strategy"}
...
class TestTrendStrategy:
    ...
    def test_calculate_position_size(self, trend_strategy):
        ...
        position_size = trend_strategy.calculate_position_size(balance=balance, price=price, risk_amount=risk_amount)
...
class TestRiskManagement:
    ...
    def test_position_size_limits(self, risk_manager, sample_position):
        ...
        is_valid = risk_manager.validate_position_size(position=sample_position, max_size=max_position_size)
    ...
    def test_stop_loss_calculation(self, risk_manager, sample_position):
        ...
        stop_loss_price = risk_manager.calculate_stop_loss(position=sample_position, stop_loss_percentage=stop_loss_pct)
...
class TestStrategyStress:
    ...
    def test_identical_prices_handling(self):
        ...
        flat_data = pd.DataFrame(
            {"open": [100] * 50, "high": [100] * 50, "low": [100] * 50, "close": [100] * 50, "volume": [1000] * 50}
        )
...
class TestStrategySecurity:
    ...
    def test_input_validation_sql_injection_attempt(self):
        ...
        malicious_config = {"ema_fast": "'; DROP TABLE orders; --", "ema_slow": 26}
