...
class TestPortfolioManager:
    ...
    def config(self: "TestEvolvableMarketMakerAgent") -> Any:
        ...
        return {
            "portfolio": {"max_positions": 10, "min_position_size": 0.01, "max_position_size": 0.5},
            "risk": {"max_drawdown": 0.2, "var_confidence": 0.95},
        }
    ...
    def sample_portfolio(self) -> dict:
        ...
        return {
            ...
            "positions": {
                ...
                "ETHUSDT": {"quantity": 10.0, "entry_price": 3000.0, "current_price": 3100.0, "unrealized_pnl": 1000.0},
            },
            "cash": 50000.0,
    ...
    async def test_rebalance_portfolio(self, portfolio_manager: PortfolioManager, sample_portfolio: dict) -> None:
        ...
        # Ребалансировка
        target_weights = {"BTCUSDT": 0.6, "ETHUSDT": 0.3, "ADAUSDT": 0.1}
    ...
    async def test_optimize_portfolio(
        self, portfolio_manager: PortfolioManager, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rebalance_portfolio_validation(
        self, portfolio_manager: PortfolioManager, sample_portfolio: dict
    ) -> None:
        ...
        # Валидация портфеля
        validation_result = await portfolio_manager.rebalance_portfolio({"BTCUSDT": 0.6, "ETHUSDT": 0.4})
