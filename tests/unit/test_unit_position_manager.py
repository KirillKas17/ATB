...
class TestPositionManager:
    ...
    def test_position_limits(self, position_manager: PositionManager) -> None:
        ...
        result = position_manager.open_position(
            symbol="BTCUSDT", side=PositionSide.LONG, size=2.0, entry_price=50000.0  # Превышает max_position_size
        )
    ...
    def test_edge_cases(self, position_manager: PositionManager) -> None:
        ...
        result = position_manager.open_position(symbol=None, side=PositionSide.LONG, size=1.0, entry_price=50000.0)
