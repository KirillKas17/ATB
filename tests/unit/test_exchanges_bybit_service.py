...
class TestBybitExchangeService:
    ...
    async def test_process_websocket_message_non_ticker_topic(self, service) -> None:
        ...
        non_ticker_message = {"topic": "orderbook.BTCUSDT", "data": {"some": "data"}}
    ...
    def test_bybit_specific_methods(self, service) -> None:
        ...
        assert (
            service._subscribe_websocket_channels.__qualname__ == "BybitExchangeService._subscribe_websocket_channels"
        )
