...
class TestStrategyExceptions:
    ...
    def test_strategy_error_with_context(self: "TestStrategyExceptions") -> None:
        ...
        context = {"strategy_id": "test_id", "parameter": "sma_period", "value": 20}
    ...
    def test_strategy_creation_error(self: "TestStrategyExceptions") -> None:
        ...
        context = {"strategy_name": "invalid_strategy", "available_strategies": ["trend_following", "mean_reversion"]}
    ...
    def test_strategy_validation_error(self: "TestStrategyExceptions") -> None:
        ...
        context = {"validation_errors": validation_errors, "strategy_type": "trend_following"}
    ...
    def test_strategy_not_found_error(self: "TestStrategyExceptions") -> None:
        ...
        strategy_id = str(uuid4())
        context = {"strategy_id": strategy_id, "search_criteria": {"name": "test_strategy"}}
    ...
    def test_strategy_duplicate_error(self: "TestStrategyExceptions") -> None:
        ...
        context = {"strategy_name": strategy_name, "existing_strategy_id": str(uuid4())}
    ...
    def test_strategy_registry_error(self: "TestStrategyExceptions") -> None:
        ...
        context = {"operation": "register", "registry_state": "full", "max_strategies": 1000}
    ...
    def test_strategy_factory_error(self: "TestStrategyExceptions") -> None:
        ...
        context = {"factory_state": "initializing", "missing_dependencies": ["config_service", "validator"]}
    ...
    def test_strategy_configuration_error(self: "TestStrategyExceptions") -> None:
        ...
        context = {"config_file": "strategy_config.json", "missing_sections": ["risk_management", "execution"]}
    ...
    def test_strategy_parameter_error(self: "TestStrategyExceptions") -> None:
        ...
        context = {"parameter_name": "sma_period", "parameter_value": -5, "valid_range": "1-100"}
    ...
    def test_strategy_type_error(self: "TestStrategyExceptions") -> None:
        ...
        context = {"expected_type": "trend_following", "actual_type": "mean_reversion", "strategy_id": str(uuid4())}
    ...
    def test_strategy_state_error(self: "TestStrategyExceptions") -> None:
        ...
        context = {"current_state": "inactive", "required_state": "active", "strategy_id": str(uuid4())}
    ...
    def test_exception_with_nested_context(self: "TestStrategyExceptions") -> None:
        ...
        nested_context = {
            ...
            "validation": {"errors": ["Error 1", "Error 2"], "warnings": ["Warning 1"]},
        }
