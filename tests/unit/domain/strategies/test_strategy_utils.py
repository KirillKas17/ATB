...
class TestStrategyUtils:
    ...
    def test_calculate_max_drawdown(self, utils) -> None:
        ...
        # Создаем серию цен
        prices = [Decimal("100"), Decimal("110"), Decimal("105"), Decimal("95"), Decimal("90"), Decimal("100")]
    ...
    def test_optimize_parameters(self, utils) -> None:
        ...
        param_ranges = {"param1": (1, 10), "param2": (5, 15)}
    ...
    def test_calculate_position_size(self, utils) -> None:
        ...
        position_size = utils.calculate_position_size(
            account_balance=account_balance, risk_per_trade=risk_per_trade, stop_loss_pct=stop_loss_pct
        )
    ...
    def test_backtest_strategy(self, utils, sample_market_data) -> None:
        ...
        def strategy_logic(market_data, params) -> Any:
            ...
            if current_price > previous_price:
                return {"action": "buy", "confidence": Decimal("0.7"), "price": current_price}
            elif current_price < previous_price:
                return {"action": "sell", "confidence": Decimal("0.6"), "price": current_price}
            return None
    ...
    def test_optimize_portfolio_weights(self, utils) -> None:
        ...
        optimal_weights = utils.optimize_portfolio_weights(
            asset_returns=asset_returns, target_return=target_return, optimization_method="efficient_frontier"
        )
