...
from domain.market_maker.mm_pattern import MarketMakerPattern, MarketMakerPatternType, PatternFeatures
...
class TestTradeSnapshot:
    ...
    def trade_snapshot(self, sample_trade_data) -> TradeSnapshot:
        ...
        return TradeSnapshot(timestamp=datetime(2024, 1, 1, 12, 0, 2), symbol="BTC/USDT", trades=sample_trade_data)

    def test_creation_with_valid_data(self, sample_trade_data):
        """Тест создания с валидными данными."""
        snapshot = TradeSnapshot(timestamp=datetime(2024, 1, 1, 12, 0, 2), symbol="BTC/USDT", trades=sample_trade_data)
    ...
    def test_get_volume_delta_sufficient_trades(self, sample_trade_data):
        ...
        snapshot = TradeSnapshot(timestamp=datetime(2024, 1, 1, 12, 0, 4), symbol="BTC/USDT", trades=extended_trades)
    ...
    def test_get_volume_delta_zero_older_volume(self, sample_trade_data):
        ...
        snapshot = TradeSnapshot(
            timestamp=datetime(2024, 1, 1, 12, 0, 2), symbol="BTC/USDT", trades=trades_with_zero_old
        )
    ...
    def test_get_volume_concentration_empty_trades(self):
        ...
        snapshot = TradeSnapshot(timestamp=datetime(2024, 1, 1, 12, 0, 0), symbol="BTC/USDT", trades=[])
