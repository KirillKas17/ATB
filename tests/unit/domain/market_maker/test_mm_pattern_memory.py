...
from domain.market_maker.mm_pattern_memory import IPatternMemoryRepository, PatternMemoryRepository, MatchedPattern
from domain.market_maker.mm_pattern import MarketMakerPattern, PatternMemory, PatternResult, PatternFeatures
...
class TestPatternMemoryRepository:
    ...
    async def test_find_similar_patterns(self, repository, sample_pattern):
        ...
        similar_patterns = await repository.find_similar_patterns("BTC/USDT", features, similarity_threshold=0.8)
    ...
    def test_write_and_read_patterns_to_file(self, repository, temp_dir):
        ...
        # Тестовые данные
        patterns = [{"id": "1", "data": "test1"}, {"id": "2", "data": "test2"}, {"id": "3", "data": "test3"}]
    ...
    def test_write_and_read_json_file(self, repository, temp_dir):
        ...
        # Тестовые данные
        data = {"key1": "value1", "key2": 123, "key3": {"nested": "data"}}
