...
def test_memory_optimization_result_to_dict():
    mor = MemoryOptimizationResult(
        optimal_similarity_threshold=0.9,
        optimal_feature_weights=np.array([1.0, 2.0, 3.0]),
        optimal_prediction_params={"param": 1},
        accuracy_improvement=0.1,
        precision_improvement=0.2,
        recall_improvement=0.3,
        f1_improvement=0.4,
        total_patterns_analyzed=100,
        patterns_removed=10,
        clusters_created=2,
