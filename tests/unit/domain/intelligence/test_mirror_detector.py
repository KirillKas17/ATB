...
class TestMirrorDetector:
    ...
    def test_detect_lagged_correlation(self, detector: MirrorDetector, sample_series1: pd.Series, sample_series2: pd.Series) -> None:
    ...
    def test_detect_mirror_signal_valid_data(self, detector: MirrorDetector, sample_series1: pd.Series, sample_series2: pd.Series) -> None:
        """Тест детекции зеркального сигнала с валидными данными."""
        signal = detector.detect_mirror_signal(
            "BTC/USD", "ETH/USD", sample_series1, sample_series2
        )
    ...
    def test_find_mirror_clusters_high_threshold(self, detector: MirrorDetector, sample_price_data: Dict[str, pd.Series]) -> None:
    ...
    def test_reset_statistics(self, detector: MirrorDetector, sample_series1: pd.Series, sample_series2: pd.Series) -> None:
    ...
    def test_mirror_signal_structure(self, detector: MirrorDetector, sample_series1: pd.Series, sample_series2: pd.Series) -> None:
    ...
    def test_correlation_matrix_structure(self, detector: MirrorDetector, sample_price_data: Dict[str, pd.Series]) -> None:
