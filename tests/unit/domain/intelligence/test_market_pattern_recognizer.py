...
from domain.intelligence.market_pattern_recognizer import MarketPatternRecognizer, PatternDetection
...
class TestMarketPatternRecognizer:
    ...
    def sample_order_book(self) -> Dict[str, Any]:
        """Тестовый ордербук."""
        return {
            "bids": [{"price": 50000, "size": 1.5}, {"price": 49999, "size": 2.0}, {"price": 49998, "size": 1.8}],
            "asks": [{"price": 50001, "size": 1.2}, {"price": 50002, "size": 2.1}, {"price": 50003, "size": 1.6}],
            "spread": 1.0,
            "timestamp": Timestamp.now(),
        }
    ...
    def test_detect_whale_absorption_valid_data(
        self, recognizer: MarketPatternRecognizer, sample_market_data: pd.DataFrame, sample_order_book: Dict[str, Any]
    ) -> None:
    ...
    def test_detect_whale_absorption_insufficient_data(
        self, recognizer: MarketPatternRecognizer, sample_order_book: Dict[str, Any]
    ) -> None:
    ...
    def test_detect_mm_spoofing_valid_data(
        self, recognizer: MarketPatternRecognizer, sample_market_data: pd.DataFrame, sample_order_book: Dict[str, Any]
    ) -> None:
    ...
    def test_detect_iceberg_detection_valid_data(
        self, recognizer: MarketPatternRecognizer, sample_market_data: pd.DataFrame, sample_order_book: Dict[str, Any]
    ) -> None:
    ...
    def test_analyze_volume_anomaly(
        self, recognizer: MarketPatternRecognizer, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_analyze_price_movement(
        self, recognizer: MarketPatternRecognizer, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_analyze_spread_widening(
        self, recognizer: MarketPatternRecognizer, sample_order_book: Dict[str, Any]
    ) -> None:
    ...
    def test_analyze_liquidity_dynamics(
        self, recognizer: MarketPatternRecognizer, sample_order_book: Dict[str, Any]
    ) -> None:
    ...
    def test_analyze_iceberg_patterns(
        self, recognizer: MarketPatternRecognizer, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_analyze_volume_consistency(
        self, recognizer: MarketPatternRecognizer, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_calculate_iceberg_confidence(self, recognizer: MarketPatternRecognizer) -> None:
        ...
        confidence = recognizer._calculate_iceberg_confidence(iceberg_analysis, price_analysis, volume_analysis)
    ...
    def test_error_handling_invalid_market_data(
        self, recognizer: MarketPatternRecognizer, sample_order_book: Dict[str, Any]
    ) -> None:
    ...
    def test_error_handling_invalid_order_book(
        self, recognizer: MarketPatternRecognizer, sample_market_data: pd.DataFrame
    ) -> None:
        """Тест обработки ошибок с невалидным ордербуком."""
        invalid_order_book = {"bids": [], "asks": [], "spread": 0.0}
