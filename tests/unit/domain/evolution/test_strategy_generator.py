...
class TestStrategyGenerator:
    ...
    def test_crossover_parameters(self, generator: StrategyGenerator) -> None:
        ...
        parent1_params = {"position_size": 0.1, "stop_loss": 0.01, "take_profit": 0.02}
        parent2_params = {"position_size": 0.2, "stop_loss": 0.02, "take_profit": 0.04}
    ...
    def test_mutation_effectiveness(self, generator: StrategyGenerator) -> None:
        ...
        assert (
            mutated_strategy.entry_conditions != original_strategy.entry_conditions
            or mutated_strategy.parameters != original_strategy.parameters
        )
