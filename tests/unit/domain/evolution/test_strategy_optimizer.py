...
from domain.type_definitions.evolution_types import FitnessScore, FitnessWeights, StrategyPerformance
...
class TestStrategyOptimizer:
    ...
    def test_optimize_strategy(
        self, optimizer: StrategyOptimizer, sample_strategy: StrategyCandidate, sample_historical_data: pd.DataFrame
    ) -> None:
    ...
    def test_validate_optimization_result(
        self, optimizer: StrategyOptimizer, sample_strategy: StrategyCandidate
    ) -> None:
    ...
    def test_improve_strategy_performance(
        self, optimizer: StrategyOptimizer, sample_strategy: StrategyCandidate
    ) -> None:
    ...
    def test_optimize_condition_complexity(
        self, optimizer: StrategyOptimizer, sample_strategy: StrategyCandidate
    ) -> None:
    ...
    def test_optimize_parameter_bounds(self, optimizer: StrategyOptimizer) -> None:
        ...
        params = {"position_size": 0.1, "stop_loss": 0.01, "take_profit": 0.02}
    ...
    def test_optimize_condition_consistency(
        self, optimizer: StrategyOptimizer, sample_strategy: StrategyCandidate
    ) -> None:
    ...
    def test_optimize_strategy_efficiency(
        self, optimizer: StrategyOptimizer, sample_strategy: StrategyCandidate
    ) -> None:
    ...
    def test_error_handling_invalid_strategy(
        self, optimizer: StrategyOptimizer, sample_historical_data: pd.DataFrame
    ) -> None:
    ...
    def test_optimization_improvement(
        ...
        assert (
            optimized_strategy.parameters != original_params
            or optimized_strategy.entry_conditions != original_entry_conditions
            or optimized_strategy.exit_conditions != original_exit_conditions
        )
