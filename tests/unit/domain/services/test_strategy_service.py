...
from domain.services.strategy_service import (
    StrategyService,
...
class TestDefaultStrategyService:
    """Тесты для DefaultStrategyService."""
    
    @pytest.fixture
    def service(self) -> DefaultStrategyService:
        """Экземпляр DefaultStrategyService."""
