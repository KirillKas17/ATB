...
from domain.type_definitions.signal_types import SignalValidationResult, SignalAggregationResult, SignalAnalysisResult
...
class TestDefaultSignalService:
    ...
    def test_validate_signal_data(self, service):
        ...
        valid_data = {"signal_type": "BUY", "strength": "STRONG", "confidence": 0.8, "price": 100.0}
    ...
    def test_generate_signal_recommendations(self, service):
        ...
        recommendations = service._generate_signal_recommendations(signals, distribution, avg_confidence)
