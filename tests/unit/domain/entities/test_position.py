...
class TestPosition:
    ...
    def sample_trading_pair(self) -> TradingPair:
        ...
        return TradingPair(symbol=Symbol("BTC/USDT"), base_currency=Currency.BTC, quote_currency=Currency.USDT)
    ...
    def test_position_from_dict(self, sample_position_data: Dict[str, Any]):
        ...
        trading_pair = TradingPair(symbol=Symbol("BTC/USDT"), base_currency=Currency.BTC, quote_currency=Currency.USDT)
