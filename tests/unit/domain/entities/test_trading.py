...
class TestTrade:
    ...
    def test_post_init_conversion(self):
        ...
        trade = Trade(quantity=Decimal("1.5"), price=Decimal("50000"), commission=Decimal("25"))
...
class TestTradingSession:
    ...
    def test_post_init_conversion(self):
        """Тест конвертации в __post_init__."""
        session = TradingSession(total_volume=Decimal("15.5"), total_commission=Decimal("250"), pnl=Decimal("5000"))
