...
class TestTechnicalIndicator:
    ...
    def test_creation(self):
        ...
        indicator = TechnicalIndicator(name="RSI", value=65.5, signal="BUY", strength=0.8, metadata={"period": 14})
    ...
    def test_validation_strength_out_of_range(self):
        ...
        with pytest.raises(ValueError, match="Strength must be between 0.0 and 1.0"):
            TechnicalIndicator(name="RSI", value=65.5, signal="BUY", strength=1.5)
    ...
    def test_validation_invalid_signal(self):
        ...
        with pytest.raises(ValueError, match="Signal must be BUY, SELL, or HOLD"):
            TechnicalIndicator(name="RSI", value=65.5, signal="INVALID", strength=0.8)
    ...
    def test_from_dict(self):
        """Тест десериализации из словаря."""
        data = {"name": "RSI", "value": 65.5, "signal": "BUY", "strength": 0.8, "metadata": {"period": 14}}
...
class TestOrderBook:
    ...
    def order_book(self) -> OrderBook:
        ...
        return OrderBook(symbol=Currency.BTC, bids=bids, asks=asks, timestamp=Timestamp(datetime.now()))
