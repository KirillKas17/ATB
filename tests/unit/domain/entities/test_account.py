...
class TestAccount:
    ...
    def test_account_creation_with_balances(self, sample_account_data: Dict[str, Any], sample_balance_data: Dict[str, Any]):
        """Тест создания аккаунта с балансами."""
        balances = [Balance(sample_balance_data["currency"], sample_balance_data["available"], sample_balance_data["locked"])]
    ...
    def test_account_update_balance(self, sample_account_data: Dict[str, Any], sample_balance_data: Dict[str, Any]):
        ...
        account = Account(**sample_account_data)
        balance = Balance(sample_balance_data["currency"], sample_balance_data["available"], sample_balance_data["locked"])
    ...
    def test_account_get_balance_by_currency(self, sample_account_data: Dict[str, Any], sample_balance_data: Dict[str, Any]):
