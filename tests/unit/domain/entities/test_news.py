...
from domain.entities.news import NewsItem, NewsAnalysis, NewsCollection, NewsSentiment, NewsCategory
...
class TestNewsCollection:
    ...
    def sample_data(self, news_items, time_range) -> Dict[str, Any]:
        """Тестовые данные."""
        return {"items": news_items, "total_count": 10, "filtered_count": 3, "time_range": time_range}
    ...
    def test_validation_negative_total_count(self, news_items, time_range):
        ...
        data = {"items": news_items, "total_count": -1, "filtered_count": 3, "time_range": time_range}
    ...
    def test_validation_negative_filtered_count(self, news_items, time_range):
        ...
        data = {"items": news_items, "total_count": 10, "filtered_count": -1, "time_range": time_range}
    ...
    def test_validation_filtered_count_exceeds_total(self, news_items, time_range):
        ...
        data = {"items": news_items, "total_count": 5, "filtered_count": 10, "time_range": time_range}
    ...
    def test_validation_invalid_time_range_order(self, news_items):
        ...
        data = {"items": news_items, "total_count": 10, "filtered_count": 3, "time_range": (start_time, end_time)}
