...
class TestPortfolioCreation:
    ...
    def test_portfolio_creation_with_timestamp(self):
        ...
        portfolio = Portfolio(name="Timestamped Portfolio", created_at=created_at)
    ...
    def test_portfolio_creation_with_metadata(self):
        ...
        metadata = {"strategy": "momentum", "target_return": "15%", "max_drawdown": "5%"}

        portfolio = Portfolio(name="Strategy Portfolio", metadata=metadata)
...
class TestPortfolioValidation:
    ...
    def test_portfolio_negative_equity_validation(self):
        ...
        with pytest.raises(ValueError, match="Total equity cannot be negative"):
            Portfolio(total_equity=Money(Decimal("-1000.00"), Currency.USD))
    ...
    def test_portfolio_zero_equity_valid(self):
        ...
        portfolio = Portfolio(total_equity=Money(Decimal("0"), Currency.USD))
    ...
    def test_portfolio_available_margin_calculation(self):
        ...
        portfolio = Portfolio(
            total_equity=Money(Decimal("10000.00"), Currency.USD), used_margin=Money(Decimal("3000.00"), Currency.USD)
        )
...
class TestPortfolioBusinessLogic:
    ...
    def test_portfolio_get_equity(self):
        ...
        portfolio = Portfolio(total_equity=Money(Decimal("50000.00"), Currency.USD))
    ...
    def test_portfolio_get_margin_ratio(self):
        ...
        portfolio = Portfolio(
            total_equity=Money(Decimal("10000.00"), Currency.USD), used_margin=Money(Decimal("2000.00"), Currency.USD)
        )
    ...
    def test_portfolio_get_margin_ratio_zero_equity(self):
        ...
        portfolio = Portfolio(
            total_equity=Money(Decimal("0"), Currency.USD), used_margin=Money(Decimal("0"), Currency.USD)
        )
    ...
    def test_portfolio_is_active(self):
        ...
        suspended_portfolio = Portfolio(status=PortfolioStatus.SUSPENDED)
    ...
    def test_portfolio_cannot_open_position_insufficient_margin(self):
        ...
        portfolio = Portfolio(
            total_equity=Money(Decimal("1000.00"), Currency.USD), used_margin=Money(Decimal("900.00"), Currency.USD)
        )
    ...
    def test_portfolio_update_equity(self):
        ...
        portfolio = Portfolio(total_equity=Money(Decimal("10000.00"), Currency.USD))
...
class TestPortfolioProtocolImplementation:
    ...
    def test_portfolio_get_equity_protocol(self):
        ...
        portfolio = Portfolio(total_equity=Money(Decimal("25000.00"), Currency.USD))
    ...
    def test_portfolio_get_margin_ratio_protocol(self):
        ...
        portfolio = Portfolio(
            total_equity=Money(Decimal("10000.00"), Currency.USD), used_margin=Money(Decimal("1500.00"), Currency.USD)
        )
...
class TestPortfolioUtilityMethods:
    ...
    def test_portfolio_equality(self):
        ...
        portfolio1 = Portfolio(id=portfolio_id, name="Test Portfolio")

        portfolio2 = Portfolio(id=portfolio_id, name="Test Portfolio")

        assert portfolio1 == portfolio2

    def test_portfolio_inequality(self):
        """Тест неравенства портфелей"""
        portfolio1 = Portfolio(id=PortfolioId(uuid4()), name="Portfolio 1")

        portfolio2 = Portfolio(id=PortfolioId(uuid4()), name="Portfolio 2")

        assert portfolio1 != portfolio2

    def test_portfolio_string_representation(self):
        """Тест строкового представления портфеля"""
        portfolio = Portfolio(name="My Trading Portfolio", total_equity=Money(Decimal("50000.00"), Currency.USD))
    ...
    def test_portfolio_to_dict(self):
        ...
        portfolio = Portfolio(name="Serialization Test", total_equity=Money(Decimal("10000.00"), Currency.USD))
...
class TestPortfolioEdgeCases:
    ...
    def test_portfolio_with_very_large_equity(self):
        ...
        portfolio = Portfolio(name="Large Portfolio", total_equity=large_equity)
    ...
    def test_portfolio_with_very_small_equity(self):
        ...
        portfolio = Portfolio(name="Small Portfolio", total_equity=small_equity)
    ...
    def test_portfolio_status_transitions(self):
        ...
        portfolio = Portfolio(name="Status Test Portfolio", status=PortfolioStatus.ACTIVE)
    ...
    def test_portfolio_metadata_auto_generation(self):
        ...
        portfolio = Portfolio(name="Metadata Test", total_equity=Money(Decimal("10000.00"), Currency.USD))
    ...
    def test_portfolio_risk_profile_validation(self):
        ...
        for risk_profile in [RiskProfile.CONSERVATIVE, RiskProfile.MODERATE, RiskProfile.AGGRESSIVE]:
            portfolio = Portfolio(name=f"{risk_profile.value} Portfolio", risk_profile=risk_profile)
...
class TestPortfolioIntegrationWithMocks:
    ...
    def test_portfolio_with_mocked_dependencies(self):
        ...
        portfolio = Portfolio(name="Mocked Portfolio", total_equity=mock_money, created_at=mock_timestamp)
