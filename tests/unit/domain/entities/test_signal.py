...
from domain.entities.signal import Signal, SignalType, SignalStrength, ExtendedMetadataValue, ExtendedMetadataDict
...
class TestSignal:
    ...
    def sample_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "metadata": {"source": "trend_analysis", "indicators": ["RSI", "MACD"], "confidence_level": 0.9},
            "is_actionable": True,
    ...
    def test_validation_negative_price(self):
        ...
        data = {"price": Money(Decimal("-100"), Currency.USD)}
    ...
    def test_validation_zero_price(self):
        ...
        data = {"price": Money(Decimal("0"), Currency.USD)}
    ...
    def test_validation_negative_stop_loss(self):
        ...
        data = {"stop_loss": Money(Decimal("-100"), Currency.USD)}
    ...
    def test_validation_zero_stop_loss(self):
        ...
        data = {"stop_loss": Money(Decimal("0"), Currency.USD)}
    ...
    def test_validation_negative_take_profit(self):
        ...
        data = {"take_profit": Money(Decimal("-100"), Currency.USD)}
    ...
    def test_validation_zero_take_profit(self):
        ...
        data = {"take_profit": Money(Decimal("0"), Currency.USD)}
    ...
    def test_risk_reward_ratio_missing_price(self):
        ...
        signal = Signal(
            stop_loss=Money(Decimal("48000"), Currency.USD), take_profit=Money(Decimal("55000"), Currency.USD)
        )
    ...
    def test_risk_reward_ratio_missing_stop_loss(self):
        ...
        signal = Signal(price=Money(Decimal("50000"), Currency.USD), take_profit=Money(Decimal("55000"), Currency.USD))

        assert signal.risk_reward_ratio is None

    def test_risk_reward_ratio_missing_take_profit(self):
        """Тест расчета соотношения риск/прибыль без take profit."""
        signal = Signal(price=Money(Decimal("50000"), Currency.USD), stop_loss=Money(Decimal("48000"), Currency.USD))
    ...
    def test_to_dict_none_values(self):
        ...
        signal = Signal(price=None, stop_loss=None, take_profit=None, quantity=None, expires_at=None)
        data = signal.to_dict()
    ...
    def test_from_dict_invalid_signal_type(self):
        ...
        data = {"signal_type": "invalid_type", "strength": "strong", "confidence": "0.8"}
    ...
    def test_from_dict_invalid_strength(self):
        ...
        data = {"signal_type": "buy", "strength": "invalid_strength", "confidence": "0.8"}
    ...
    def test_from_dict_invalid_confidence(self):
        ...
        data = {"signal_type": "buy", "strength": "strong", "confidence": "invalid_confidence"}
    ...
    def test_from_dict_invalid_price(self):
        ...
        data = {"signal_type": "buy", "strength": "strong", "confidence": "0.8", "price": "invalid_price"}
    ...
    def test_from_dict_invalid_stop_loss(self):
        ...
        data = {"signal_type": "buy", "strength": "strong", "confidence": "0.8", "stop_loss": "invalid_stop_loss"}
    ...
    def test_from_dict_invalid_take_profit(self):
        ...
        data = {"signal_type": "buy", "strength": "strong", "confidence": "0.8", "take_profit": "invalid_take_profit"}
    ...
    def test_from_dict_invalid_quantity(self):
        ...
        data = {"signal_type": "buy", "strength": "strong", "confidence": "0.8", "quantity": "invalid_quantity"}
    ...
    def test_from_dict_invalid_timestamp(self):
        ...
        data = {"signal_type": "buy", "strength": "strong", "confidence": "0.8", "timestamp": "invalid_timestamp"}
    ...
    def test_from_dict_invalid_expires_at(self):
        ...
        data = {"signal_type": "buy", "strength": "strong", "confidence": "0.8", "expires_at": "invalid_expires_at"}
