...
class TestPattern:
    ...
    def test_pattern_with_complex_characteristics(self):
        ...
        characteristics = {
            "price_levels": {"resistance": [50000, 51000, 52000], "support": [48000, 47000, 46000]},
            "volume_analysis": {"avg_volume": 1000000, "volume_trend": "increasing", "volume_ratio": 1.5},
            "time_analysis": {"formation_time": "2_weeks", "breakout_time": "1_day", "consolidation_period": "5_days"},
            "technical_indicators": {
                "rsi": 65.5,
                "macd": {"signal": 0.002, "histogram": 0.001},
                "bollinger_bands": {"upper": 52000, "lower": 48000, "middle": 50000},
            },
            "market_context": {"trend": "bullish", "volatility": "medium", "liquidity": "high"},
        }
    ...
    def test_pattern_with_extensive_metadata(self):
        ...
        metadata = {
            ...
            "model_version": "1.2.3",
            "training_data": {"period": "2020-2023", "markets": ["crypto", "forex", "stocks"], "accuracy": 0.85},
            "validation_metrics": {"precision": 0.82, "recall": 0.78, "f1_score": 0.80},
            "market_conditions": {"volatility_regime": "high", "trend_strength": "strong", "correlation_regime": "low"},
            "risk_assessment": {"success_probability": 0.75, "risk_reward_ratio": 2.5, "max_drawdown": 0.15},
    ...
    def test_pattern_immutability(self):
        ...
        pattern = Pattern(
            pattern_type=BasePatternType.DOUBLE_TOP, characteristics={"level": 50000}, confidence=PatternConfidence.HIGH
        )
    ...
    def test_pattern_serialization_compatibility(self):
        ...
        pattern = Pattern(
            ...
            characteristics={"neckline": 50000, "head": 52000, "shoulders": [51000, 51000]},
    ...
    def test_pattern_with_nested_characteristics(self):
        ...
        characteristics = {
            "price_action": {
                "swings": {"highs": [52000, 52500, 53000], "lows": [48000, 47500, 47000]},
                "momentum": {"rsi_divergence": True, "macd_crossover": "bullish"},
            },
            "volume_profile": {
                "distribution": {"high_volume_nodes": [50000, 51000], "low_volume_nodes": [49000, 52000]}
            },
        }
    ...
    def test_pattern_trading_pair_format(self):
        ...
        trading_pairs = ["BTC/USD", "ETH/USDT", "ADA/BTC", "DOT/USD", "LINK/ETH"]
