...
# MarketRegimeDetector не найден в infrastructure.core
# from infrastructure.core.market_regime_detector import MarketRegimeDetector



class MarketRegimeDetector:
    """Детектор рыночных режимов для тестов."""
...
class TestMarketRegimeDetector:
    ...
    def test_detect_market_regime(
        self, market_regime_detector: MarketRegimeDetector, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_predict_regime_changes(
        self, market_regime_detector: MarketRegimeDetector, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_calculate_regime_metrics(
        self, market_regime_detector: MarketRegimeDetector, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_identify_regime_characteristics(
        self, market_regime_detector: MarketRegimeDetector, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_analyze_regime_stability(
        self, market_regime_detector: MarketRegimeDetector, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_detect_regime_anomalies(
        self, market_regime_detector: MarketRegimeDetector, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_generate_regime_signals(
        self, market_regime_detector: MarketRegimeDetector, sample_market_data: pd.DataFrame
    ) -> None:
