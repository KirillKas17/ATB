...
class TestMLProtocol:
    ...
    def mock_ml_protocol(self, model_config: ModelConfig) -> Mock:
        ...
        ml_protocol.create_model = AsyncMock(
            return_value=Model(
                id=uuid4(),
        ...
        ml_protocol.load_model = AsyncMock(
            return_value=Model(
                id=uuid4(),
                name=model_config.name,
                model_type=model_config.model_type,
        ...
        ml_protocol.train_model = AsyncMock(
        ...
        ml_protocol.preprocess_data = AsyncMock(
            return_value=(
        ...
        ml_protocol.predict_batch = AsyncMock(
            return_value=PredictionResult(
                model_id="model_123",
        ...
        ml_protocol.evaluate_model = AsyncMock(
        ...
        ml_protocol.analyze_market = AsyncMock(
        ...
        ml_protocol.generate_signal = AsyncMock(
            return_value=SignalResult(
                signal_type="hold",
                confidence=0.65,
                price_target=None,
    ...
    async def test_ml_errors(self, mock_ml_protocol: Mock) -> None:
        ...
        with pytest.raises(ModelValidationError):
            await mock_ml_protocol.create_model(
                ModelConfig(
                    name="test",
                    model_type=ModelType.RANDOM_FOREST,
                    trading_pair=Symbol("BTCUSDT"),
    ...
    async def test_feature_importance_analysis(self, mock_ml_protocol: Mock) -> None:
        ...
        feature_importance = {"price": 0.3, "volume": 0.2, "rsi": 0.25, "macd": 0.25}
...
class TestModelConfig:
    ...
    def test_model_config_validation(self: "TestModelConfig") -> None:
        ...
        assert valid_config.model_type in [
...
class TestModelMetrics:
    ...
    def test_model_metrics_validation(self: "TestModelMetrics") -> None:
        ...
        expected_f1 = (
            2 * (valid_metrics.precision * valid_metrics.recall) / (valid_metrics.precision + valid_metrics.recall)
        )
