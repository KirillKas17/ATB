...
from domain.exceptions.protocol_exceptions import ValidationError, ConnectionError, TransactionError
from domain.entities.order import Order, OrderType, OrderSide, OrderStatus
from domain.value_objects.money import Money
from domain.value_objects.currency import Currency
from decimal import Decimal
from domain.type_definitions.base_types import OrderId
...
class TestRepositoryProtocol:
    ...
    def test_validation_error(self, mock_repository: Mock) -> None:
        ...
        mock_repository.update.side_effect = ValidationError(
            "Invalid data", "field_name", "invalid_value", "validation_rule"
        )
