...
class TestFeatureEngineer:
    ...
    def test_add_technical_indicators(
        self, feature_engineer: FeatureEngineer, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_add_microstructure_features(
        self, feature_engineer: FeatureEngineer, sample_market_data: pd.DataFrame
    ) -> None:
    ...
    def test_save_and_load_features(
        self, feature_engineer: FeatureEngineer, sample_market_data: pd.DataFrame, tmp_path
    ) -> None:
