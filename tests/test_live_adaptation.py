...
class TestLiveAdaptation:
    ...
    def test_update_state(self, adaptation, sample_data, sample_trades):
    ...
    def test_calculate_trend(self, adaptation, sample_data):
        """Тест расчета тренда"""
        trend = adaptation._calculate_trend(sample_data)
        assert isinstance(trend, float)

    def test_detect_regime(self, adaptation, sample_data):
    ...
    def test_calculate_position_size_factor(self, adaptation):
...
class TestLiveAdaptationModel:
    ...
    def test_initialization(self, adaptation_model):
        """Тест инициализации"""
    ...
    def test_update(self, adaptation_model, sample_data):
    ...
    def test_predict(self, adaptation_model, sample_data):
        """Тест предсказания"""
        model_id = "test_model"
        model = adaptation_model.models.get(model_id)
    ...
    def test_get_metrics(self, adaptation_model, sample_data):
    ...
    def test_get_history(self, adaptation_model, sample_data):
    ...
    def test_reset(self, adaptation_model, sample_data):
