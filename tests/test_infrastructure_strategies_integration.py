...
class TestTrendStrategy:
    ...
    def test_calculate_indicators(self, trend_strategy, data_fixture, request) -> None:
    ...
    def test_validate_signal(self, trend_strategy, mock_market_data) -> None:
    ...
    def test_calculate_position_size(self, trend_strategy, mock_market_data) -> None:
...
class TestVolatilityStrategy:
    ...
    def test_calculate_volatility(self, volatility_strategy, data_fixture, request) -> None:
    ...
    def test_calculate_risk_metrics(self, volatility_strategy, mock_market_data) -> None:
...
class TestManipulationStrategy:
    ...
    def test_detect_manipulation(self, manipulation_strategy, data_fixture, request) -> None:
...
class TestRegimeAdaptiveStrategy:
    ...
    def test_detect_regime(self, regime_adaptive_strategy, data_fixture, request) -> None:
    ...
    def test_validate_adaptation(self, regime_adaptive_strategy, mock_market_data) -> None:
        ...
        assert isinstance(is_valid, bool)
    def test_calculate_regime_metrics(self, regime_adaptive_strategy, mock_market_data) -> None:
