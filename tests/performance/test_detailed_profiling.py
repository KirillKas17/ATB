...
class TestDetailedProfiling:
    ...
    def test_feature_engineering_profiling(self, profiler: PerformanceProfiler, large_dataset: pd.DataFrame):
        ...
        with profiler.profile_function("technical_indicators"):
            temp_config = FeatureConfig(
                use_technical_indicators=True, use_statistical_features=False, use_time_features=False
            )
        ...
        with profiler.profile_function("statistical_features"):
            temp_config = FeatureConfig(
                use_technical_indicators=False, use_statistical_features=True, use_time_features=False
            )
            temp_engineer = FeatureEngineer(config=temp_config)
        ...
        with profiler.profile_function("time_features"):
            temp_config = FeatureConfig(
                use_technical_indicators=False, use_statistical_features=False, use_time_features=True
            )
            temp_engineer = FeatureEngineer(config=temp_config)
    ...
    def test_cprofile_detailed_analysis(self, profiler: PerformanceProfiler, large_dataset: pd.DataFrame):
        ...
        result, profile_output = profiler.profile_with_cprofile(engineer.generate_features, large_dataset)
        ...
        profiler.function_calls["detailed_profile"] = {"slow_functions": slow_functions, "full_output": profile_output}
...
class TestPerformanceRegression:
    ...
    def test_performance_regression_feature_engineering(self, baseline_performance: Dict[str, float]):
        ...
        assert (
            execution_time < regression_threshold
...
class TestPerformanceOptimizations:
    ...
    def test_memory_efficient_operations(self):
        ...
        assert memory_used_efficient < memory_used_inefficient, "Efficient method should use less memory"
