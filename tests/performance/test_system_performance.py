...
class TestPerformanceBenchmarks:
    ...
    def test_concurrent_processing_performance(self, large_market_data: pd.DataFrame):
        ...
        chunks = [large_market_data.iloc[i : i + chunk_size] for i in range(0, len(large_market_data), chunk_size)]
...
class TestStressTests:
    ...
    def test_concurrent_users_simulation(self):
        ...
        print(
            f"Concurrent users test: {total_time:.2f}s total, avg: {avg_execution_time:.3f}s, max: {max_execution_time:.3f}s"
        )
...
class TestScalabilityTests:
    ...
    def test_horizontal_scaling_simulation(self):
        ...
        print(
            f"Horizontal scaling: {total_time:.2f}s total, max node: {max_node_time:.2f}s, avg node: {avg_node_time:.2f}s"
        )
    ...
    def test_data_volume_scaling(self):
        ...
        for size in data_sizes:
            ...
            results.append({"size": size, "execution_time": execution_time, "throughput": throughput})
