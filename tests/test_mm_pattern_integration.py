...
from domain.market_maker.mm_pattern_classifier import MarketMakerPatternClassifier, OrderBookSnapshot, TradeSnapshot
...
from application.types import ExecuteStrategyRequest, ExecuteStrategyResponse
from domain.type_definitions.market_maker_types import Symbol, Confidence
...
class TestMMPatternIntegration:
    ...
    def follow_controller(self, pattern_classifier, pattern_memory) -> Any:
        ...
        return MarketMakerFollowController(pattern_classifier=pattern_classifier, pattern_memory=pattern_memory)
    ...
    def sample_order_book(self: "TestEvolvableMarketMakerAgent") -> Any:
        ...
        return OrderBookSnapshot(
            ...
            symbol="BTCUSDT",
            bids=[{"price": 50000.0, "size": 1.5}, {"price": 49999.0, "size": 2.0}, {"price": 49998.0, "size": 1.0}],
            asks=[{"price": 50001.0, "size": 1.0}, {"price": 50002.0, "size": 2.5}, {"price": 50003.0, "size": 1.5}],
            last_price=50000.0,
    ...
    def sample_trades(self: "TestEvolvableMarketMakerAgent") -> Any:
        ...
        return TradeSnapshot(
            ...
            symbol="BTCUSDT",
            trades=[
                {"time": datetime.now(), "price": 50000.0, "size": 0.1, "side": "buy"},
                {"time": datetime.now(), "price": 50001.0, "size": 0.2, "side": "sell"},
                {"time": datetime.now(), "price": 50000.5, "size": 0.15, "side": "buy"},
            ],
        )
    ...
    async def test_pattern_classification(self, pattern_classifier, sample_order_book, sample_trades) -> None:
        ...
        pattern = pattern_classifier.classify_pattern("BTCUSDT", sample_order_book, sample_trades)
    ...
    async def test_pattern_memory_operations(self, pattern_memory) -> None:
        ...
        similar_patterns = await pattern_memory.find_similar_patterns("BTCUSDT", features, similarity_threshold=0.7)
    ...
    async def test_follow_controller_processing(self, follow_controller, sample_order_book, sample_trades) -> None:
        ...
        follow_signal = await follow_controller.process_pattern("BTCUSDT", sample_order_book, sample_trades)
    ...
    @pytest.mark.asyncio
    async def test_orchestrator_mm_pattern_analysis(self) -> None:
        ...
        follow_controller = MarketMakerFollowController(
            pattern_classifier=pattern_classifier, pattern_memory=pattern_memory
        )
        mm_storage = Mock()
...
class DummyRepo:
    ...
    @pytest.mark.asyncio
    async def test_orchestrator_execute_strategy_mm_e2e(self) -> None:
        ...
        # Запрос
        req = ExecuteStrategyRequest(strategy_id="s1", portfolio_id="p1", symbol=symbol)
        # Вызов
