...
class TestSessionInfluenceAnalyzerIntegration:
    ...
    def mock_orderbook_data(self: "TestEvolvableMarketMakerAgent") -> Any:
        ...
        return {
            ...
            "asks": [[50001.0, 1.2], [50002.0, 1.8], [50003.0, 0.8]],
    ...
    def test_agent_context_session_influence_modifier(
        self, agent_context, session_influence_analyzer, mock_orderbook_data
    ) -> None:
    ...
    def test_agent_context_session_influence_status(
        self, agent_context, session_influence_analyzer, mock_orderbook_data
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_trading_orchestrator_session_influence_integration(
        self, mock_trading_orchestrator, session_influence_analyzer
    ) -> None:
    ...
    def test_session_influence_analyzer_confidence_calculation(
        self, session_influence_analyzer, mock_orderbook_data
    ) -> None:
    ...
    def test_session_influence_analyzer_impact_calculations(
        self, session_influence_analyzer, mock_orderbook_data
    ) -> None:
    ...
    def test_agent_context_session_influence_with_high_influence(
        self, agent_context, session_influence_analyzer
    ) -> None:
    ...
    def test_agent_context_session_influence_with_low_influence(
        self, agent_context, session_influence_analyzer
    ) -> None:
    ...
    def test_session_influence_analyzer_edge_cases(self, session_influence_analyzer) -> None:
        ...
        empty_data = {"bids": [], "asks": [], "timestamp": datetime.now().isoformat(), "symbol": "BTCUSDT"}
    ...
    def test_session_influence_analyzer_integration_with_signal(
        self, session_influence_analyzer, mock_orderbook_data
    ) -> None:
        """Тест интеграции SessionInfluenceAnalyzer с торговыми сигналами."""
        # Создаем торговый сигнал
        signal = Signal(
            signal_type=SignalType.BUY, trading_pair="BTCUSDT", confidence=0.8, strength=0.7, timestamp=datetime.now()
        )
