...
def test_market_state_creation(sample_market_state):
...
def test_market_state_serialization(sample_market_state):
...
def test_market_state_manager_add_state(market_state_manager, sample_market_state):
...
def test_market_state_manager_lookback(market_state_manager):
...
def test_market_regime_detection(market_state_manager):
...
def test_support_resistance_levels(market_state_manager):
...
def test_market_metrics(market_state_manager):
