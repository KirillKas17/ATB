...
from ml.decision_reasoner import DecisionReasoner, DecisionReport, TradeDecision
...
def test_initialization(decision_reasoner):
    """Тест инициализации"""
...
def test_explain_decision(decision_reasoner, sample_data, sample_model):
...
def test_feature_importance(decision_reasoner, sample_data, sample_model):
...
def test_technical_indicators(decision_reasoner, sample_data):
...
def test_market_context(decision_reasoner, sample_data):
...
def test_explanation_generation(decision_reasoner):
...
def test_visualization_creation(decision_reasoner):
...
def test_report_saving(decision_reasoner):
...
def test_report_retrieval(decision_reasoner):
...
def test_error_handling(decision_reasoner):
...
def test_feature_preparation(decision_reasoner, sample_data):
...
class TestDecisionReasoner:
    ...
    def test_initialization(self, reasoner, tmp_path):
        """Тест инициализации"""
        assert reasoner.log_dir == tmp_path
        assert (tmp_path / "decision_reason.log").exists()

    def test_explain_hold_decision(self, reasoner, tmp_path):
    ...
    def test_explain_open_decision(self, reasoner, trade_decision, market_data):
    ...
    def test_explain_without_optional_data(self, reasoner, trade_decision):
