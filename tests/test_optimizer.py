...
def test_generate_param_combinations(config, param_grid):
    optimizer = Optimizer(config)
...
def test_optimize_sequential(config, sample_data, param_grid):
    optimizer = Optimizer(config)
...
def test_get_best_parameters(config, sample_data, param_grid):
    optimizer = Optimizer(config)
    strategy = MockStrategy({})
...
def test_get_optimization_statistics(config, sample_data, param_grid):
    optimizer = Optimizer(config)
    strategy = MockStrategy({})
    optimizer.optimize(sample_data, strategy, param_grid)
