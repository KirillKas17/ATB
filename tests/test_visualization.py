...
class TestVisualization:
    ...
    def test_plot_fuzzy_zones(self, price_data, zones):
    ...
    def test_plot_whale_activity(self, trade_data):
    ...
    def test_plot_cvd_and_delta_volume(self, price_data, volume_data):
