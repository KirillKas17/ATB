...
from analysis.pattern_discovery import Pattern, PatternConfig, PatternDiscovery
...
@pytest.fixture
def pattern_discovery(pattern_config):
...
class TestPatternDiscovery:
    ...
    def test_cluster_patterns(self, pattern_discovery, mock_market_data):
    ...
    def test_find_price_patterns(self, pattern_discovery, mock_market_data):
    ...
    def test_find_volume_patterns(self, pattern_discovery, mock_market_data):
    ...
    def test_evaluate_pattern(self, pattern_discovery, mock_market_data):
    ...
    def test_error_handling(self, pattern_discovery):
    ...
    def test_pattern_combining(self, pattern_discovery, mock_market_data):
    ...
    def test_technical_indicators(self, pattern_discovery, mock_market_data):
    ...
    def test_trend_calculation(self, pattern_discovery, mock_market_data):
        """Тест расчета тренда"""
        # Тест с реальными данными
    ...
    def test_volume_profile(self, pattern_discovery, mock_market_data):
    ...
    def test_pattern_filtering(self, pattern_discovery, mock_market_data):
