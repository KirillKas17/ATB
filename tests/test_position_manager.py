...
class TestPosition:
    def test_position_initialization(self, mock_position):
    ...
    def test_calculate_margin(self, mock_position):
        """Тест расчета маржи"""
        margin = mock_position.calculate_margin()
        assert margin == 50000.0  # size * entry_price / leverage

    def test_calculate_pnl_long(self, mock_position):
    ...
    def test_get_duration(self, mock_position):
...
class TestPositionManager:
    def test_open_position(self, position_manager, mock_position):
    ...
    def test_close_position(self, position_manager, mock_position):
    ...
    def test_update_position(self, position_manager, mock_position):
    ...
    def test_get_average_roi(self, position_manager):
    ...
    def test_get_max_drawdown(self, position_manager):
    ...
    def test_get_position_correlation(self, position_manager):
    ...
    def test_risk_metrics(self, position_manager):
