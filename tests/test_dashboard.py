...
async def dashboard(mock_market_state, mock_model_selector):
...
class TestDashboard:
    def test_get_symbols(self, dashboard):
    ...
    @pytest.mark.asyncio
    async def test_start_and_stop_bot(self, dashboard):
    ...
    @pytest.mark.asyncio
    async def test_start_training(self, dashboard):
    ...
    def test_get_pair_status(self, dashboard):
    ...
    def test_get_all_pairs_status(self, dashboard):
    ...
    def test_pair_status(self, dashboard):
        """Тест статуса пары"""
    ...
    @pytest.mark.asyncio
    async def test_high_load_async(self, dashboard):
...
class TestDashboardAPI:
    ...
    def test_get_pair_status(self, client):
        """Тест получения статуса пары"""
    ...
    def test_get_all_pairs_status(self, client):
        """Тест получения статуса всех пар"""
