...
from infrastructure.evolution.exceptions import (
    StorageError, CacheError, BackupError, MigrationError,
    SerializationError, ValidationError, ConnectionError, QueryError
)
...
class TestExceptionContext:
    ...
    def test_exception_details_access(self) -> None:
