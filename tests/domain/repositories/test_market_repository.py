...
class TestMarketRepository:
    ...
    def test_get_markets_by_price_range(self, repository, sample_markets):
        ...
        markets_in_range = repository.get_markets_by_price_range(
            min_price=Decimal("1000.00"), max_price=Decimal("10000.00")
        )
    ...
    def test_get_markets_by_volume_range(self, repository, sample_markets):
        ...
        high_volume_markets = repository.get_markets_by_volume_range(min_volume=Decimal("500000.00"), max_volume=None)
    ...
    def test_get_markets_by_multiple_criteria(self, repository, sample_markets):
        ...
        criteria_markets = repository.get_markets_by_multiple_criteria(is_active=True, min_volume=Decimal("500000.00"))

        assert len(criteria_markets) == 2
        assert all(market.is_active and market.volume_24h >= Decimal("500000.00") for market in criteria_markets)
