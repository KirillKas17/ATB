...
class TestBaseRepositoryImpl:
    ...
    def repository(self):
        ...
        return BaseRepositoryImpl[TestEntity]()
    
    @pytest.fixture
    def sample_entities(self) -> List[TestEntity]:
        """Тестовые сущности."""
        return [
            TestEntity("1", "Entity 1", Decimal("100.00")),
            TestEntity("2", "Entity 2", Decimal("200.00")),
            TestEntity("3", "Entity 3", Decimal("300.00"))
        ]
    ...
    def test_add_duplicate_entity(self, repository, sample_entities):
        ...
        duplicate_entity = TestEntity("1", "Duplicate", Decimal("999.00"))
    ...
    def test_update_existing_entity(self, repository, sample_entities):
        ...
        updated_entity = TestEntity("1", "Updated Entity", Decimal("150.00"))
    ...
    def test_update_not_found(self, repository, sample_entities):
        ...
        entity = TestEntity("999", "Not Found", Decimal("999.00"))
    ...
    def test_find_one_by_criteria_multiple_results(self, repository, sample_entities):
        ...
        entity1 = TestEntity("1", "Entity 1", Decimal("100.00"))
        entity2 = TestEntity("2", "Entity 2", Decimal("100.00"))
    ...
    def test_bulk_update(self, repository, sample_entities):
        ...
        updated_entities = [
            TestEntity("1", "Updated 1", Decimal("150.00")),
            TestEntity("2", "Updated 2", Decimal("250.00")),
            TestEntity("3", "Updated 3", Decimal("350.00"))
        ]
    ...
    def test_bulk_update_not_found(self, repository, sample_entities):
        ...
        updated_entities = [
            TestEntity("1", "Updated 1", Decimal("150.00")),
            TestEntity("999", "Not Found", Decimal("999.00"))
        ]
    ...
    def test_save_existing_entity(self, repository, sample_entities):
        ...
        updated_entity = TestEntity("1", "Updated", Decimal("999.00"))
    ...
    def test_repository_immutability(self, repository, sample_entities):
        ...
        # Поскольку TestEntity неизменяема, создаем новую
        modified_entity = TestEntity(entity.id, "Modified", Decimal("999.00"))
    ...
    def test_repository_thread_safety(self, repository, sample_entities):
        ...
        def add_entities():
            for i in range(10):
                entity = TestEntity(f"thread_{i}", f"Thread Entity {i}", Decimal(str(i)))
                repository.add(entity)
                time.sleep(0.001)
