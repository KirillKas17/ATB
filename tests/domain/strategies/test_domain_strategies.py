...
class TestStrategyTypes(unittest.TestCase):
    ...
    def test_trend_following_params(self) -> None:
        ...
        params = TrendFollowingParams(
            short_period=10, long_period=20, rsi_period=14, trend_strength_threshold=Decimal("0.7")
        )
    ...
    def test_mean_reversion_params(self) -> None:
        ...
        params = MeanReversionParams(
            lookback_period=50, deviation_threshold=Decimal("2.0"), bb_period=20, bb_std_dev=Decimal("2.0")
        )
...
class TestStrategyFactory(unittest.TestCase):
    ...
    def test_create_nonexistent_strategy(self) -> None:
        ...
        with self.assertRaises(StrategyNotFoundError):
            self.factory.create_strategy(name="nonexistent_strategy", trading_pairs=["BTC/USDT"])
    ...
    def test_factory_stats(self) -> None:
        ...
        for i in range(3):
            self.factory.create_strategy(
                name="trend_following", trading_pairs=["BTC/USDT"], parameters={"confidence_threshold": Decimal("0.7")}
            )
...
class TestStrategyRegistry(unittest.TestCase):
    ...
    def test_register_strategy(self) -> None:
        ...
        strategy_id = self.registry.register_strategy(strategy=self.strategy, name="Test Strategy")
    ...
    def test_duplicate_registration(self) -> None:
        ...
        self.registry.register_strategy(strategy=self.strategy, name="Test Strategy")
...
class TestStrategyValidator(unittest.TestCase):
    ...
    def test_validate_strategy_config(self) -> None:
        ...
        config = {
            ...
            "trading_pairs": ["BTC/USDT"],
            "parameters": {"confidence_threshold": "0.7", "risk_level": "medium", "max_position_size": "0.1"},
        }
...
class TestStrategyUtils(unittest.TestCase):
    ...
    def test_calculate_win_rate(self) -> None:
        ...
        trades = [{"pnl": Decimal("10")}, {"pnl": Decimal("-5")}, {"pnl": Decimal("15")}, {"pnl": Decimal("-3")}]
...
class TestStrategyRiskManager(unittest.TestCase):
    ...
    def test_calculate_position_size_kelly(self) -> None:
        ...
        position_size = self.risk_manager.calculate_position_size(account_balance, confidence=confidence)
        self.assertIsInstance(position_size, Decimal)
    ...
    def test_check_risk_limits(self) -> None:
        ...
        within_limits, violations = self.risk_manager.check_risk_limits(current_drawdown, daily_pnl, total_exposure)
...
class TestStrategyOptimizer(unittest.TestCase):
    ...
    def test_grid_search_optimization(self) -> None:
        ...
        best_params, best_score = self.optimizer.optimize_parameters(Mock(), parameter_ranges, evaluation_function)
