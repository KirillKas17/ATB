...
class TestPatternDiscovery:
    ...
    def test_discover_price_patterns_insufficient_data(self, pattern_discovery) -> None:
        ...
        insufficient_data = pd.DataFrame({"close": [50000, 50001, 50002], "volume": [1000, 1001, 1002]})
    ...
    def test_pattern_discovery_integration_with_different_patterns(
        self, pattern_discovery, sample_pattern_data
    ) -> None:
