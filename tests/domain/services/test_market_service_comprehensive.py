...
class TestMarketServiceComprehensive:
    ...
    def test_support_resistance_levels(self):
        ...
        price_history = [
            Decimal('100'), Decimal('105'), Decimal('102'), Decimal('108'),
            Decimal('103'), Decimal('107'), Decimal('104'), Decimal('109'),
    ...
    def test_trend_detection(self):
        ...
        uptrend_prices = [
            ...
            Decimal('106'), Decimal('108')
        ]
        
        # Downtrend data
        downtrend_prices = [
            Decimal('108'), Decimal('106'), Decimal('104'), 
    ...
    async def test_async_data_processing(self, mock_repository, mock_exchange_client):
        ...
        mock_exchange_client.get_orderbook.return_value = {
            'bids': [[50000, 1.0]],
            'asks': [[50010, 1.0]]
        }
        ...
        tasks = [
            mock_exchange_client.get_ticker('BTCUSDT'),
            mock_exchange_client.get_orderbook('BTCUSDT')
        ]
