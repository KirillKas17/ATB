...
class TestOrderValidationService:
    ...
    def sample_balance(self) -> Balance:
        """Тестовый баланс."""
        return Balance(currency="USD", available=Decimal("10000.00"), reserved=Decimal("0.00"))
    ...
    def test_validate_order_insufficient_balance(self, service, sample_trading_pair, sample_balance, sample_order_data):
        ...
        insufficient_balance = Balance(currency="USD", available=Decimal("1000.00"), reserved=Decimal("0.00"))
    ...
    def test_validate_order_sell_side(self, service, sample_trading_pair, sample_balance, sample_order_data):
        ...
        btc_balance = Balance(currency="BTC", available=Decimal("10.0"), reserved=Decimal("0.0"))
    ...
    def test_validate_order_sell_insufficient_base_balance(
        self, service, sample_trading_pair, sample_balance, sample_order_data
    ):
        """Тест валидации заказа на продажу с недостаточным балансом базовой валюты."""
        sample_order_data["side"] = OrderSide.SELL

        # Недостаточный баланс в базовой валюте
        insufficient_btc_balance = Balance(currency="BTC", available=Decimal("0.1"), reserved=Decimal("0.0"))
    ...
    def test_validate_order_with_reserved_balance(
        self, service, sample_trading_pair, sample_balance, sample_order_data
    ):
        """Тест валидации с зарезервированным балансом."""
        # Баланс с зарезервированными средствами
        balance_with_reserved = Balance(currency="USD", available=Decimal("5000.00"), reserved=Decimal("5000.00"))
    ...
    def test_validate_order_validation_result_structure(
        self, service, sample_trading_pair, sample_balance, sample_order_data
    ):
