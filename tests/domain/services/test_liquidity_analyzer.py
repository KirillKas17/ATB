...
from domain.type_definitions.service_types import LiquidityAnalysisResult, LiquidityZone, LiquiditySweep
...
class TestLiquidityAnalyzer:
    ...
    def test_identify_liquidity_zones_insufficient_data(self, liquidity_analyzer) -> None:
        ...
        insufficient_data = pd.DataFrame({"high": [50000, 50001], "low": [49999, 50000], "volume": [1000, 1001]})
    ...
    def test_detect_liquidity_sweeps_insufficient_data(self, liquidity_analyzer) -> None:
        ...
        insufficient_data = pd.DataFrame(
            {"high": [50000, 50001, 50002], "low": [49999, 50000, 50001], "volume": [1000, 1001, 1002]}
        )
    ...
    def test_liquidity_analyzer_integration_with_market_data(
        self, liquidity_analyzer, sample_market_data, sample_order_book
    ) -> None:
