...
class TestStrategy(StrategyProtocolImpl):
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "TestStrategy":
        return cls(
            id=data["id"],
            name=data["name"],
...
class TestStrategyProtocol:
    ...
    @pytest.fixture
    def strategy(self, sample_parameters) -> TestStrategy:
        """Тестовая стратегия."""
        return TestStrategy(
            id="strategy_001",
            name="Test Strategy",
