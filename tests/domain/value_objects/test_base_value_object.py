...
class TestBaseValueObject:
    ...
    def sample_data(self) -> Dict[str, Any]:
        """Тестовые данные."""
        return {"value": Decimal("100.50"), "name": "test_object"}

    def test_creation(self, sample_data):
        """Тест создания Value Object."""
        obj = TestValueObject(value=sample_data["value"], name=sample_data["name"])
    ...
    def test_validation_negative_value(self, sample_data):
        ...
        with pytest.raises(ValidationError, match="Value cannot be negative"):
            TestValueObject(value=Decimal("-100.00"), name=sample_data["name"])

    def test_validation_empty_name(self, sample_data):
        """Тест валидации пустого имени."""
        with pytest.raises(ValidationError, match="Name cannot be empty"):
            TestValueObject(value=sample_data["value"], name="")
    ...
    def test_from_dict(self, sample_data):
        ...
        data = {"value": str(sample_data["value"]), "name": sample_data["name"]}
    ...
    def test_equality(self, sample_data):
        ...
        obj1 = TestValueObject(value=sample_data["value"], name=sample_data["name"])

        obj2 = TestValueObject(value=sample_data["value"], name=sample_data["name"])
    ...
    def test_inequality(self, sample_data):
        ...
        obj2 = TestValueObject(value=Decimal("200.00"), name=sample_data["name"])
    ...
    def test_inequality_different_name(self, sample_data):
        ...
        obj2 = TestValueObject(value=sample_data["value"], name="different_name")
    ...
    def test_inequality_different_type(self, sample_data):
        ...
        obj2 = DifferentValueObject(value=sample_data["value"], name=sample_data["name"])
    ...
    def test_hash_different_objects(self, sample_data):
        ...
        obj3 = TestValueObject(value=sample_data["value"], name="different_name")
    ...
    def test_from_dict_invalid_data(self, sample_data):
        ...
        # Неверный тип данных
        data = {"value": "invalid_decimal", "name": sample_data["name"]}
    ...
    def test_value_object_in_collections(self, sample_data):
        ...
        obj2 = TestValueObject(value=Decimal("200.00"), name="obj2")

        obj3 = TestValueObject(value=sample_data["value"], name=sample_data["name"])
