...
class TestPrice:
    ...
    def sample_data(self) -> Dict[str, Any]:
        """Тестовые данные."""
        return {"value": Decimal("50000.00"), "currency": Currency.USD, "precision": 2}

    def test_creation(self, sample_data):
        """Тест создания Price."""
        price = Price(value=sample_data["value"], currency=Currency.USD)
    ...
    def test_creation_with_default_precision(self, sample_data):
        ...
        price = Price(value=sample_data["value"], currency=sample_data["currency"])
    ...
    def test_validation_empty_currency(self):
        ...
        price = Price(value=Decimal("100.00"), currency="")
    ...
    def test_validation_invalid_precision(self):
        ...
        with pytest.raises(TypeError, match="unexpected keyword argument 'precision'"):
            Price(value=Decimal("100.00"), currency=Currency.USD, precision=10)

    def test_add(self, sample_data):
        """Тест сложения цен."""
        price1 = Price(value=sample_data["value"], currency=sample_data["currency"])

        price2 = Price(value=Decimal("10000.00"), currency=sample_data["currency"])
    ...
    def test_add_different_currencies(self, sample_data):
        ...
        price2 = Price(value=Decimal("10000.00"), currency=Currency.EUR)
    ...
    def test_subtract_result_negative(self, sample_data):
        ...
        price1 = Price(value=Decimal("10000.00"), currency=sample_data["currency"])

        price2 = Price(value=sample_data["value"], currency=sample_data["currency"])
    ...
    def test_compare_greater_than(self, sample_data):
        ...
        price2 = Price(value=Decimal("40000.00"), currency=sample_data["currency"])
    ...
    def test_compare_different_currencies(self, sample_data):
        ...
        price2 = Price(value=sample_data["value"], currency=Currency.EUR)
    ...
    def test_percentage_change(self, sample_data):
        ...
        old_price = Price(value=Decimal("40000.00"), currency=sample_data["currency"])

        new_price = Price(value=sample_data["value"], currency=sample_data["currency"])
    ...
    def test_percentage_change_negative(self, sample_data):
        ...
        old_price = Price(value=sample_data["value"], currency=sample_data["currency"])

        new_price = Price(value=Decimal("40000.00"), currency=sample_data["currency"])
    ...
    def test_round_to_precision(self, sample_data):
        ...
        price = Price(value=Decimal("50000.123456"), currency=sample_data["currency"])
    ...
    def test_from_dict(self, sample_data):
        ...
        data = {"value": str(sample_data["value"]), "currency": "USD", "quote_currency": "USD"}
    ...
    def test_inequality(self, sample_data):
        ...
        price2 = Price(value=Decimal("60000.00"), currency=Currency.USD)
