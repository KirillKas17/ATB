...
class TestValueObjectFactory:
    ...
    def test_create_volume(self, factory, sample_data):
        ...
        volume = factory.create_volume(
            value=sample_data["volume_value"],
            unit="BTC"
        )
    ...
    def test_create_percentage(self, factory, sample_data):
        ...
        percentage = factory.create_percentage(
            value=sample_data["percentage_value"]
        )
    ...
    def test_create_timestamp(self, factory, sample_data):
        ...
        timestamp = factory.create_timestamp(
            value=sample_data["timestamp_value"]
        )
    ...
    def test_create_currency(self, factory, sample_data):
        ...
        currency = factory.create_currency(
            code=sample_data["currency_code"]
        )
    ...
    def test_create_from_dict_volume(self, factory, sample_data):
        ...
        data = {
            "type": "volume",
            "value": str(sample_data["volume_value"]),
            "unit": "BTC",
            "precision": 6
        }
    ...
    def test_create_from_dict_percentage(self, factory, sample_data):
        ...
        data = {
            "type": "percentage",
            "value": str(sample_data["percentage_value"]),
            "precision": 2
        }
    ...
    def test_create_from_dict_timestamp(self, factory, sample_data):
        ...
        data = {
            "type": "timestamp",
            "value": sample_data["timestamp_value"].isoformat()
        }
    ...
    def test_create_volume_with_invalid_value(self, factory):
        ...
        with pytest.raises(ValidationError):
            factory.create_volume(
                value=Decimal("-100.0"),  # Отрицательное значение
                unit="BTC"
            )
    ...
    def test_create_price_with_invalid_value(self, factory, sample_data):
        ...
        with pytest.raises(ValidationError):
            factory.create_price(
                value=Decimal("-100.00"),  # Отрицательное значение
                currency_code=sample_data["currency_code"]
            )
    ...
    def test_create_money_with_invalid_amount(self, factory, sample_data):
        ...
        with pytest.raises(ValidationError):
            factory.create_money(
                amount=Decimal("-100.00"),  # Отрицательное значение
                currency_code=sample_data["currency_code"]
            )
    ...
    def test_get_supported_types(self, factory):
        ...
        expected_types = [
            "money", "price", "volume", "percentage", "timestamp",
            "currency", "balance", "signal", "trading_pair"
        ]
