...
class TestMoney:
    ...
    def test_money_creation_with_different_types(self) -> None:
    ...
    def test_money_addition_different_currencies(self) -> None:
        ...
        with pytest.raises(ValueError, match="Cannot add money with different currencies"):
            money1 + money2
    def test_money_addition_with_non_money(self) -> None:
    ...
    def test_money_subtraction(self) -> None:
        ...
        assert result.currency == Currency.USD
    def test_money_subtraction_different_currencies(self) -> None:
        ...
        with pytest.raises(ValueError, match="Cannot subtract money with different currencies"):
            money1 - money2
    def test_money_subtraction_with_non_money(self) -> None:
    ...
    def test_money_multiplication_with_non_number(self) -> None:
    ...
    def test_money_division_by_zero(self) -> None:
        """Тест деления на ноль."""
        money = Money(100, Currency.USD)
        with pytest.raises(ValueError, match="Cannot divide by zero"):
            money / 0
    def test_money_division_with_non_number(self) -> None:
    ...
    def test_money_comparison(self) -> None:
        ...
        assert money1 <= money3
        assert money1 >= money3
    def test_money_comparison_different_currencies(self) -> None:
        ...
        with pytest.raises(ValueError, match="Cannot compare money with different currencies"):
            money1 < money2
    def test_money_comparison_with_non_money(self) -> None:
    ...
    def test_money_repr_representation(self) -> None:
    ...
    def test_money_utility_methods(self) -> None:
    ...
    def test_money_class_methods(self) -> None:
        ...
        assert money.amount == Decimal("100.50000000")
        assert money.currency == Currency.USD
    def test_money_from_string_invalid(self) -> None:
