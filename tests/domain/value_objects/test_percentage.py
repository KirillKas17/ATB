...
class TestPercentage:
    ...
    def test_percentage_immutability(self: "TestPercentage") -> None:
        """Тест неизменяемости."""
    ...
    def test_percentage_addition(self: "TestPercentage") -> None:
    ...
    def test_percentage_subtraction(self: "TestPercentage") -> None:
    ...
    def test_percentage_multiplication(self: "TestPercentage") -> None:
    ...
    def test_percentage_division(self: "TestPercentage") -> None:
    ...
    def test_percentage_division_by_zero(self: "TestPercentage") -> None:
    ...
    def test_percentage_comparison(self: "TestPercentage") -> None:
    ...
    def test_percentage_comparison_with_non_percentage(self: "TestPercentage") -> None:
    ...
    def test_percentage_string_representation(self: "TestPercentage") -> None:
    ...
    def test_percentage_repr_representation(self: "TestPercentage") -> None:
        """Тест представления для отладки."""
        p = Percentage(Decimal("10.5"))
        assert repr(p) == "Percentage(10.5)"

    def test_percentage_equality(self: "TestPercentage") -> None:
        """Тест равенства."""
        p1 = Percentage(Decimal("10.5"))
    ...
    def test_percentage_utility_methods(self: "TestPercentage") -> None:
    ...
    def test_percentage_rounding(self: "TestPercentage") -> None:
        """Тест округления."""
    ...
    def test_percentage_conversion(self: "TestPercentage") -> None:
        """Тест преобразований."""
        p = Percentage(Decimal("10.5"))
    ...
    def test_percentage_application(self: "TestPercentage") -> None:
    ...
    def test_percentage_range_check(self: "TestPercentage") -> None:
    ...
    def test_percentage_serialization(self: "TestPercentage") -> None:
        """Тест сериализации."""
        p = Percentage(Decimal("10.5"))
    ...
    def test_percentage_class_methods(self: "TestPercentage") -> None:
    ...
    def test_percentage_from_string_invalid(self: "TestPercentage") -> None:
    ...
    def test_percentage_hash(self: "TestPercentage") -> None:
        """Тест хеширования."""
        p1 = Percentage(Decimal("10.5"))
        p2 = Percentage(Decimal("10.5"))
        p3 = Percentage(Decimal("20.0"))
