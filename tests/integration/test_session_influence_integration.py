...
class TestSessionInfluenceIntegration:
    ...
    def test_apply_session_influence_to_signal(self, trading_orchestrator) -> None:
        ...
        original_signal = {"action": "buy", "confidence": 0.7, "price": 50000, "quantity": 1.0}
        # Применяем влияние сессий
        modified_signal = trading_orchestrator._apply_session_influence_to_signal(context, original_signal)
    ...
    def test_session_influence_in_execute_strategy(self, trading_orchestrator, mock_market_data) -> None:
        ...
        market = Market(symbol="BTC/USD", base_currency=Currency("BTC"), quote_currency=Currency("USD"))
        # Выполняем стратегию
    ...
    def test_session_influence_in_process_signal(self, trading_orchestrator) -> None:
        ...
        signal = {"action": "buy", "confidence": 0.7, "price": 50000, "quantity": 1.0}
        # Обрабатываем сигнал
    ...
    def test_session_influence_error_handling(self, trading_orchestrator) -> None:
        ...
        trading_orchestrator._session_influence_analyzer.analyze_session_influence.side_effect = Exception(
            "Analysis error"
        )
    ...
    def test_session_influence_with_empty_market_data(self, trading_orchestrator) -> None:
        ...
        context = AgentContext(symbol="BTC/USD")
        empty_market_data = {"orderbook": {"bids": [], "asks": []}, "trades": [], "session_info": {}}
