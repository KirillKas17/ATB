...
class TestStrategiesMainCycleIntegration:
    ...
    @pytest.mark.asyncio
    async def test_trading_orchestrator_integration(self, trading_orchestrator, strategy_factory, strategy_registry) -> None:
    ...
    async def test_strategy_registry_integration(self, trading_orchestrator, strategy_registry) -> None:
        ...
        for i in range(5):
            ...
            strategy_id = strategy_registry.register_strategy(
                strategy=strategy,
                name=f"Registry Test {i}",
                tags=["registry", "test", f"version_{i}"],
                priority=i + 1
            )
    ...
    async def test_strategy_validator_integration(self, trading_orchestrator, strategy_validator) -> None:
        ...
        assert len(validation_result.errors) > 0
    @pytest.mark.asyncio
    async def test_complete_strategy_lifecycle_integration(self, trading_orchestrator, strategy_factory, strategy_registry, strategy_validator) -> None:
    ...
    @pytest.mark.asyncio
    async def test_performance_monitoring_integration(self, trading_orchestrator, strategy_factory, strategy_registry) -> None:
    ...
    @pytest.mark.asyncio
    async def test_infrastructure_strategies_integration(self, trading_orchestrator, strategy_factory, strategy_registry) -> None:
