...
class TestSymbolsWorkflowIntegration:
    ...
    def test_complete_symbol_analysis_workflow(
        self, workflow_components, realistic_market_data, realistic_order_book
    ) -> None:
        ...
        profile = SymbolProfile(
            ...
            volume_profile=VolumeProfile(
                current_volume=VolumeValue(realistic_market_data["volume"].iloc[-1]),
                volume_trend=VolumeValue(0.1),
                volume_stability=ConfidenceValue(0.8),
            ),
            price_structure=PriceStructure(
                current_price=PriceValue(realistic_market_data["close"].iloc[-1]),
                atr=ATRValue(1.0),
                atr_percent=0.01,
                vwap=VWAPValue(realistic_market_data["close"].mean()),
    ...
    def test_symbol_analysis_with_market_regime_changes(
        self, workflow_components, realistic_market_data, realistic_order_book
    ) -> None:
    ...
    def test_symbol_analysis_error_recovery(
        self, workflow_components, realistic_market_data, realistic_order_book
    ) -> None:
    ...
    def test_symbol_analysis_data_persistence(
        self, workflow_components, realistic_market_data, realistic_order_book
    ) -> None:
