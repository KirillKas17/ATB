...
from domain.intelligence.entanglement_detector import EntanglementDetector, EntanglementResult, OrderBookUpdate
...
class TestEntanglementMonitor:
    ...
    @pytest.mark.asyncio
    async def test_start_monitoring_short(self: "TestEntanglementMonitor") -> None:
