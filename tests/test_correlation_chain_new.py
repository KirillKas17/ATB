...
class TestCorrelationChain:
    ...
    def test_initialization(self, correlation_chain):
        """Тест инициализации"""
    ...
    def test_calculate_correlation(self, correlation_chain, sample_series):
    ...
    def test_add_metrics(self, correlation_chain, sample_series):
    ...
    def test_get_metrics(self, correlation_chain, sample_series):
    ...
    def test_get_correlation_matrix(self, correlation_chain, sample_series):
    ...
    def test_cointegration_calculation(self, correlation_chain, sample_series):
    ...
    def test_granger_causality(self, correlation_chain, sample_series):
    ...
    def test_lead_lag_relationship(self, correlation_chain, sample_series):
    ...
    def test_regime_dependency(self, correlation_chain, sample_series):
    ...
    def test_stability_score(self, correlation_chain, sample_series):
    ...
    def test_breakpoints(self, correlation_chain, sample_series):
    ...
    def test_serialization(self, correlation_chain, sample_series):
