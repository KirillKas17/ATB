...
@pytest_asyncio.fixture
async def order_manager(bybit_client):
...
@pytest_asyncio.fixture
async def account_manager(bybit_client):
...
class TestBybitClient:
    @pytest.mark.asyncio
    async def test_create_order(self, bybit_client):
...
class TestOrderManager:
    @pytest.mark.asyncio
    async def test_create_entry_order(self, order_manager):
...
class TestAccountManager:
    def test_get_account_info(self, account_manager):
    ...
    def test_set_leverage(self, account_manager):
...
class TestMarketData:
    @pytest.mark.asyncio
    async def test_get_klines(self, market_data):
    ...
    @pytest.mark.asyncio
    async def test_get_orderbook(self, market_data):
...
def test_error_handling(bybit_client):
...
def test_data_validation(bybit_client):
...
def test_rate_limiting(bybit_client):
