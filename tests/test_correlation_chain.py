...
from analysis.correlation_chain import CorrelationChain, CorrelationPair
...
@pytest.fixture
def correlation_chain(correlation_config, mock_market_data):
...
class TestCorrelationChain:
    ...
    def test_find_correlations(self, correlation_chain):
    ...
    def test_get_strongest_pairs(self, correlation_chain):
    ...
    def test_get_correlation_matrix(self, correlation_chain):
    ...
    def test_update_data(self, correlation_chain, mock_market_data):
    ...
    def test_get_correlation_chain(self, correlation_chain, mock_market_data):
    ...
    def test_plot_correlation_matrix(self, correlation_chain, mock_market_data):
        """Тест построения матрицы корреляций"""
        correlation_chain.update_data(mock_market_data)
        fig = correlation_chain.plot_correlation_matrix()
        assert fig is not None

    def test_error_handling(self, correlation_chain):
